...
public class ItemRenderer
{
    ...
    private void func_178105_d(float p_178105_1_) {
    	if(ModManager.getModByName("Animation").isEnabled() && Animation.sanimation.getValueState().booleanValue()) {
    		float var2 = -0.15f * MathHelper.sin(MathHelper.sqrt_float(p_178105_1_) * 3.1415927f);
            float var3 = -0.05f * MathHelper.sin(MathHelper.sqrt_float(p_178105_1_) * 3.1415927f * 1.5f);
            float var4 = -0.0f * MathHelper.sin(p_178105_1_ * 3.1415927f);
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (abstractclientplayer.getItemInUseCount() > 0)
            {
                ...
                switch (enumaction)
                {
                    ...
                    case BLOCK:
                    	if(ModManager.getModByName("Animation").isEnabled() && Animation.mode.isCurrentMode("Sigma") || (ModManager.getModByName("Killaura").isEnabled() && Killaura.autoblock.getValueState().booleanValue())) {
                    	...
                    	} else if(ModManager.getModByName("Animation").isEnabled() && Animation.mode.isCurrentMode("Push")) {
                    		this.transformFirstPersonItem(f, 0.0F);
                            this.func_178103_d();
                            float var14 = MathHelper.sin(f1 * f1 * 3.1415927F);
                            float var15 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
