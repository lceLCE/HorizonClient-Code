...
public class GuiNewChat extends Gui
{
                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                ...
                                //TTF Chat
                                if(this.canTTFChat()) {
                                	ClientUtil.INSTANCE.sansation19.drawStringWithShadow(s, i2, (float)(j2 - 7.5f), 16777215 + (l1 << 24));
                                } else {
                                    this.mc.fontRendererObj.drawStringWithShadow(s, (float)i2 + chatline.x - width, (float)(j2 - 8), 16777215 + (l1 << 24));
                                }
    ...
    public boolean canTTFChat() {
    	return HUD.ttfChat.getValueState().booleanValue() && ModManager.getModByName("HUD").isEnabled();
    }
