...
public class Tiplan {
	public String tiplan = sendGet("https://sslapi.hitokoto.cn/?charset=gbk",null);
	...
	public Tiplan() {
		...
		if(hitokoto.equalsIgnoreCase("null")) {
			Display.setTitle(Client.CLIENT_name + "  " + Client.CLIENT_VER + " | ERROR:Request Tiplan Failed");
		} else {
			Display.setTitle(Client.CLIENT_name + "  " + Client.CLIENT_VER + " | " + hitokoto + "  ---" + from);
		}
	}
